...
<div class="form-group">
    <select name="[FIELD_NAME]" id="[FIELD_NAME]" class="form-control input-sm index-search">
        ...
        @foreach(\$[FIELD_NAME1]_list as \$item)
        <option value="{{\$item['id']}}" @if(isset($[FIELD_NAME]) && '' !== $[FIELD_NAME] && $[FIELD_NAME] == \$item['id'])selected @endif >{{\$item['[RELATION_SHOW]']}}</option>
        @endforeach
    </select>
</div>
<script>
...
<div class="form-group">
    <input value="{{isset(\$[FIELD_NAME]) ? \$[FIELD_NAME] : ''}}" readonly name="[FIELD_NAME]" id="[FIELD_NAME]" class="form-control input-sm indexSearchDateRange" placeholder="[FORM_NAME]">
</div>
<script>
    laydate.render({
        elem: '#[FIELD_NAME]',
...
<div class="form-group">
    <input value="{{isset(\$[FIELD_NAME]) ? \$[FIELD_NAME] : ''}}" readonly name="[FIELD_NAME]" id="[FIELD_NAME]" class="form-control input-sm indexSearchDatetimeRange" placeholder="[FORM_NAME]">
</div>
<script>
    laydate.render({
        elem: '#[FIELD_NAME]',
...
@foreach(\$item['[FIELD_NAME]'] as \$item_[FIELD_NAME])
