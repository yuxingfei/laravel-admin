...
<div class="form-group">
    ...
    <div class="col-sm-8 ">
        ...
        <input name="[FIELD_NAME_LNG]" hidden id="[FIELD_NAME_LNG]" value="{{isset(\$data['[FIELD_NAME_LNG]']) ? \$data['[FIELD_NAME_LNG]'] : '[FIELD_DEFAULT_LNG]'}}">
        <input name="[FIELD_NAME_LAT]" hidden id="[FIELD_NAME_LAT]" value="{{isset(\$data['[FIELD_NAME_LAT]']) ? \$data['[FIELD_NAME_LAT]'] : '[FIELD_DEFAULT_LAT]'}}" >
    </div>
</div>
