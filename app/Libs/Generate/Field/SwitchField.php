...
<div class="form-group">
    ...
    <input class="input-switch"  id="[FIELD_NAME]" value="1" @if(!isset(\$data) || \$data['[FIELD_NAME]'] == 1)checked @endif type="checkbox" />
    <input class="switch field-switch" placeholder="[FORM_NAME]" name="[FIELD_NAME]" value="{{isset(\$data['[FIELD_NAME]']) ? \$data['[FIELD_NAME]'] : '[FIELD_DEFAULT]'}}" hidden />
    </div>
</div>\n
<script>
