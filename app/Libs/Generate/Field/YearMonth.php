...
<div class="form-group">
    ...
    <div class="col-sm-10 col-md-4">
        <input id="[FIELD_NAME]" readonly name="[FIELD_NAME]" value="{{isset(\$data['[FIELD_NAME]']) ? \$data['[FIELD_NAME]'] : '[FIELD_DEFAULT]'}}" placeholder="请选择[FORM_NAME]" type="text" class="form-control filed-year-month">
    </div>
</div>
<script>
    laydate.render({
