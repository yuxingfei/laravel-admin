...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form class="form-inline searchForm" id="searchForm" action="{{url('admin/admin_role/index')}}" method="GET">
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header">
                    <div>
                        <a title="添加" data-toggle="tooltip" class="btn btn-primary btn-sm " href="{{url('admin/admin_role/add')}}">
                        ...
                        <a class="btn btn-danger btn-sm AjaxButton" data-toggle="tooltip" title="删除选中数据"
                           ...
                           data-url="{{url('admin/admin_role/del')}}">
                        ...
                        <a class="btn btn-success btn-sm AjaxButton" data-toggle="tooltip" title="启用选中数据"
                           ...
                           data-url="{{url('admin/admin_role/enable')}}">
                        ...
                        <a class="btn btn-warning btn-sm AjaxButton" data-toggle="tooltip" title="禁用选中数据"
                           ...
                           data-url="{{url('admin/admin_role/disable')}}">
                            <i class="fa fa-circle"></i> 禁用
                        </a>

                        <a class="btn btn-success btn-sm ReloadButton" data-toggle="tooltip" title="刷新"
                           data-id="checked" data-url="{{url('admin/admin_role/del')}}">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="td-do">
                                <a href="{{url('admin/admin_role/access',['id'=>$item['id']])}}"
                                   class="btn btn-warning btn-xs" data-toggle="tooltip" title="授权">
                                    <i class="fa fa-key"></i>
                                </a>

                                <a href="{{url('admin/admin_role/edit',['id'=>$item['id']])}}"
