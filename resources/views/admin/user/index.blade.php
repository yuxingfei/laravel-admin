...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form class="form-inline searchForm" id="searchForm" action="{{url('admin/user/index')}}" method="GET">
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header">
                    <div>
                        <a title="添加" data-toggle="tooltip" class="btn btn-primary btn-sm " href="{{url('admin/user/add')}}">
                        ...
                        <a class="btn btn-success btn-sm AjaxButton" data-toggle="tooltip" title="启用选中数据"
                           ...
                           data-url="{{url('admin/user/enable')}}">
                        ...
                        <a class="btn btn-warning btn-sm AjaxButton" data-toggle="tooltip" title="禁用选中数据"
                           ...
                           data-url="{{url('admin/user/disable')}}">
